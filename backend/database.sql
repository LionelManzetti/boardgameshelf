...
(9, 'Time Bomb', 4, 8, 10, 30, 10, 'https://s3-us-west-1.amazonaws.com/5cc.images/games/uploaded/1567443476036', 324, 2016, "party, hidden, negotiation", "Each player will be assigned a secret identity, Agent or Terrorist. The game will unroll in a maximum of four rounds in which the agents want to defuse the bomb and the terrorists want it to explode."),
